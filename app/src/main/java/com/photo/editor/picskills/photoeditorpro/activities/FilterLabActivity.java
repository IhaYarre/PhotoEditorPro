...
import com.photo.editor.picskills.photoeditorpro.adapter.FiltersForegroundAdapter;
import com.photo.editor.picskills.photoeditorpro.adapter.StickerCategoryListAdapter;
import com.photo.editor.picskills.photoeditorpro.adapter.StyleAdapter;
import com.photo.editor.picskills.photoeditorpro.ads.PIXStyleClickListener;
import com.photo.editor.picskills.photoeditorpro.callback.FilterPixItemClickListener;
...
import com.photo.editor.picskills.photoeditorpro.custom.MultiTouchListener;
...
public class FilterLabActivity extends ParentActivity implements View.OnClickListener {
    static {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filter_lab);
        Thread.setDefaultUncaughtExceptionHandler(new MyExceptionHandlerPix(FilterLabActivity.this));
        ...
        if (bmpPic != null) {
            ...
            StyleAdapter pixStyleAdapter = new StyleAdapter(FilterLabActivity.this, arrIcon, new PIXStyleClickListener() {
                @Override
    ...
    public void prepareThumbnailBackground(final Bitmap thumbBitmaps) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                List<Filter> filters = FilterPack.getFilterPack(FilterLabActivity.this);
                ...
                thumbnailItemList.addAll(ThumbnailsManager.processThumbs(FilterLabActivity.this));
    ...
    public void openShareActivity() {
        Intent intent = new Intent(FilterLabActivity.this, ShareSerpActivity.class);
    ...
    private class saveImageTaskMaking extends AsyncTask<String, String, Exception> {
        ...
        protected Exception doInBackground(String... strings) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    if (uri != null)
                        savedImageUri = uri;
                    notifyMediaScannerService(FilterLabActivity.this, uri.getPath());
                    ...
                    if (uri != null)
                        savedImageUri = uri;
                    notifyMediaScannerService(FilterLabActivity.this, myDir.getAbsolutePath());
                }
            } catch (Exception e) {
                return e;
            }
        ...
        protected void onPostExecute(Exception e) {
            ...
            if (e == null) {
               ...
               /* *//*FullScreenAdManager.fullScreenAdsCheckPref(FilterLabActivity.this, FullScreenAdManager.ALL_PREFS.ATTR_ON_SHARE_SCREEN, new FullScreenAdManager.GetBackPointer() {
                    @Override
             ...
             *//*       }
                ...
                Toast.makeText(FilterLabActivity.this, e.toString(), Toast.LENGTH_SHORT).show();
            }
        }
    }
