...
public class Constants {
    ...
    public static final String KEY_SELECTED_PIX_STYLE = "Style";
    ...
    public static String VALUE_OPEN_FROM_WINGS = "openFromWings";
    public static String VALUE_OPEN_FROM_FRAME = "openFromFrame";
...
//            return decodeFileDescriptor;
    ...
    public static Bitmap getBitmapFromUriDrip(Context context, Uri uri, float f, float f2) throws IOException {
        try {
            ParcelFileDescriptor openFileDescriptor = context.getContentResolver().openFileDescriptor(uri, "r");
            FileDescriptor fileDescriptor = openFileDescriptor.getFileDescriptor();
            BitmapFactory.Options options = new BitmapFactory.Options();
